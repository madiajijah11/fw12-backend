...
exports.createPaymentMethods = (data, cb) => {
  const sql = 'INSERT INTO "paymentMethods" ("picture", "name") VALUES ($1,$2) RETURNING *'
...
exports.updatePaymentMethods = (id, data, cb) => {
  const sql =
    'UPDATE "paymentMethods" SET "picture" = COALESCE(NULLIF($1,\'\'), "picture"), "name" = COALESCE(NULLIF($2,\'\'), "name") WHERE id = $3 RETURNING *'
