...
exports.createMovieCast = (data, cb) => {
  const sql = 'INSERT INTO "movieCast" ("movieId", "castId") VALUES ($1,$2) RETURNING *'
...
exports.updateMovieCast = (id, data, cb) => {
  const sql =
    'UPDATE "movieCast" SET "movieId" = COALESCE(NULLIF($1,\'\')::INTEGER, "movieId")::INTEGER "castId" = COALESCE(NULLIF($2, \'\')::INTEGER, "castId")::INTEGER WHERE id = $3 RETURNING *'
