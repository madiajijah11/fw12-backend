...
movieSchedulesRoutes.patch('/:id', movieSchedulesController.updateMovieSchedules)
movieSchedulesRoutes.delete('/:id', movieSchedulesController.deleteMovieSchedules)
