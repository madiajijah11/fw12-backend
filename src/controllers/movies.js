...
exports.getMovie = (req, res) => {
  getMovie(req.params.id, (err, result) => {
    ...
    if (result.rows < 1) {
      ...
      return responseHandler(200, true, 'Movie retrieved successfully', null, result.rows[0], res)
    }
  })
}
...
exports.createMovie = (req, res) => {
  ...
  if (!errors.isEmpty()) {
    return responseHandler(400, false, 'All fields must be filled', null, errors.array(), res)
  }
  if (req.file) {
  ...
  createMovie(req.body, (err, result) => {
    ...
    return responseHandler(201, true, 'Movie created successfully', null, result.rows[0], res)
  })
}
...
exports.updateMovie = (req, res) => {
  ...
  updateMovie(req.params.id, req.body, (err, result) => {
    ...
    return responseHandler(201, true, 'Movie updated successfully', null, result.rows[0], res)
  })
}
...
exports.deleteMovie = (req, res) => {
  deleteMovie(req.params.id, (err, result) => {
    ...
    return responseHandler(200, true, 'Movie deleted successfully', null, result.rows[0], res)
  })
}

exports.upComingMovies = (req, res) => {
  const sortables = ['title', 'releaseDate', 'createdAt', 'updatedAt']
  filter(req.query, sortables, countAllUpcomingMovies, res, (filter, pageInfo) => {
...
exports.nowShowingMovies = (req, res) => {
  ...
  filter(req.query, sortables, countAllNowShowingMovies, res, (filter, pageInfo) => {
...
exports.getScheduleByMovieId = (req, res) => {
  getScheduleByMovieId(req.params.id, req.query.city, req.query.date, (err, result) => {
    if (err) {
      return errorHandling(err, res)
    }
    return responseHandler(200, true, 'Schedule retrieved successfully', null, result.rows, res)
  })
}
