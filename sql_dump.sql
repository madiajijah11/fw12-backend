...
--
-- Name: mexl_cinema; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE mexl_cinema WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'English_United States.1252';


ALTER DATABASE mexl_cinema OWNER TO postgres;
